...
void write_register_mma8451(char reg, char value){                // WRITE function receives the Control Register 1 and the ax direction
...
char read_register_mma8451(char reg){                             // READ function does only get as a parameter the register to be read
    char data;
